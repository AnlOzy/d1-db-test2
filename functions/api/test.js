  ...
  try {
    ...
    if (!tableCheck || tableCheck.count === 0) {
      ...
      await db.batch([
        ...
        db.prepare("INSERT OR IGNORE INTO Hotel (HotelName) VALUES ('Hotel 1'), ('Hotel 2'), ('Hotel 3'), ('Hotel 4'), ('Hotel 5')"),
        ...
        db.prepare(`INSERT OR IGNORE INTO People (People_id, first_name, family_name, DateOfBirth, Gender, National_Insurance, Country, Language, Hotel, Postcode, Nottingham_Address) VALUES 
          ...
          ('P002', 'Amelia', 'Smith', '1988-11-20', 'Female', 'AB445566C', 'United Kingdom', 'English', 'Hotel 2', 'NG1 1AA', '123 Victoria St'),
          ('P003', 'Noah', 'Jones', '1992-02-15', 'Male', 'TN778899Z', 'United Kingdom', 'English', 'Hotel 1', 'NG2 3BB', '45 Station Rd'),
          ('P004', 'Isla', 'Jones', '1994-07-30', 'Female', 'XY223344B', 'United Kingdom', 'English', 'Hotel 4', 'NG2 3BB', '45 Station Rd'),
          ('P015', 'Ella', 'Robinson', '1998-09-09', 'Female', 'ER001122N', 'India', 'Hindi', 'Hotel 2', 'NG1 9HH', '42 Bridlesmith Gate'),
          ('P005', 'Leo', 'Taylor', '1980-01-01', 'Male', 'PP554433D', 'United Kingdom', 'English', 'Hotel 3', 'NG7 4LL', '88 Derby Rd'),
          ('P006', 'Ava', 'Taylor', '1982-12-12', 'Female', 'LM667788E', 'United Kingdom', 'English', 'Hotel 3', 'NG8 5PP', '12 Wollaton Rd'),
          ('P007', 'George', 'Taylor', '2000-03-22', 'Male', 'JW123456F', 'United Kingdom', 'English', 'Hotel 4', 'NG1 2CC', '99 Mansfield Rd'),
          ('P008', 'Harry', 'Brown', '1995-05-05', 'Male', 'HB998877G', 'United Kingdom', 'English', 'Hotel 5', 'NG3 5GG', '10 Park Row'),
          ('P009', 'Mia', 'Wilson', '1991-08-12', 'Female', 'MW112244H', 'United Kingdom', 'English', 'Hotel 2', 'NG1 5QQ', '22 Forest Rd'),
          ...
          ('P012', 'Jack', 'Roberts', '1993-02-02', 'Male', 'JR334455K', 'Germany', 'German', 'Hotel 3', 'NG1 6EE', '14 Canal St'),
          ('P013', 'Grace', 'Walker', '1996-06-06', 'Female', 'GW778899L', 'United Kingdom', 'English', 'Hotel 3', 'NG1 7FF', '33 Fletcher Gate'),
          ('P014', 'Freddie', 'Wright', '1984-03-03', 'Male', 'FW121212M', 'Nigeria', 'Yoruba', 'Hotel 4', 'NG1 8GG', '9 Low Pavement')`),
